...
workload_path = "/home/jiang.2091/bert-exp/workload/"
command = "python3 /home/jiang.2091/bert-exp/pareto/src/pareto.py"
commands = []
for s in ["0.1", "0.05", "0.01"]:
    commands.append(command + " " + workload_path + s + "/input_ids.txt")
experiments = [];
for c in commands:
