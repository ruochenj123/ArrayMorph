...
vols = ["s3_get", "s3_merge", "s3_lambda", "s3_multi_fetch", "s3_pareto_25"]
workload_path = "/home/jiang.2091/s3-hyperslab/exp/synthetic/small/workload/0.05/"
workloads = ["small_column_test.txt", "small_row_test.txt"]
commands = []

for vol in vols:
	for w in workloads:
		commands.append(program + " " + vol + " " + workload_path + w + " sythetic_small_4MB.h5")
