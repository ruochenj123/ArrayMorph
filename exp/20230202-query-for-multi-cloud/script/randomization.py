...
program = "../build/build/read 1200 1200 20000 1000"

vols = ["s3_get", "s3_merge", "s3_lambda", "azure_get", "azure_merge", "gc_get", "gc_merge", "gc_lambda"]
commands = []

for vol in vols:
	commands.append(program + " " + vol)
